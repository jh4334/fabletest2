...
연구실 오른쪽 문의 **「필터버블 미로」**는 방탈출식 개념 체험 공간입니다 —
"추천(늘 보던 것)" 문만 고르면 같은 자리로 되돌아오고, **✨새로운 길**을
골라야 빠져나올 수 있어, 필터버블을 퀴즈가 아니라 **몸으로 겪으며** 배웁니다.
...
자비로 마음을 되돌린 몬스터는 사라지지 않고 그 자리에 ♥와 함께
**친구로 남아**, 말을 걸면 자기가 배운 점을 다시 들려줍니다. 자비가
쌓이면 되돌린 친구들이 마을에 놀러 오고 할머니의 대사도 달라져요 —
**선택이 세계에 남습니다.** (냉정하게 떠나보낸 몬스터는 자리에 없습니다)
...
보스 난이도는 **1장 쉽게 → 5장 어렵게** 단계적으로 오릅니다 — 챕터가
올라갈수록 보스 HP가 늘고(4→8) 탄막이 빠르고 촘촘해지며, 후반 보스는
하트를 겨냥하는 추적탄을 포함한 **다단계 패턴**으로 점점 거세집니다.
...
src/data.js       맵 22개, NPC, 몬스터, 퀴즈, 도감, 보스 공격, 조사 텍스트, 대사
