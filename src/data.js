...
const MAP_PROPS = {
  ...
  tiltstreet: [
    { x: 5, y: 6, kind: 'ch2_district', label: '메아리 골목 입구',
      text: '왼쪽 위 반짝문 주변에 같은 화살표가 여러 겹 겹쳐 있다.\n다들 이쪽이라고 말하지만, 화살표 끝은 제자리로 휘어 있다.' },
    { x: 22, y: 6, kind: 'ch2_district', label: '표본 창고 입구',
    ...
    { x: 26, y: 10, kind: 'ch2_district', label: '동쪽 소란 문',
      text: '동쪽 벽 너머에서 종이 넘기는 소리와 속보 알림이 새어 나온다.\n기울을 되돌린 뒤에야 다음 거리로 이어질 듯하다.' },
  ],
  rumorstreet: [
    { x: 14, y: 5, kind: 'ch3_district', label: '신문사 입구',
    ...
    { x: 9, y: 6, kind: 'ch3_district', label: '대문짝 헤드라인',
      text: '거리 벽을 덮은 속보 헤드라인이 지나치게 크다.\n글자가 클수록 출처는 더 작게 숨어 있는 것 같다.' },
    { x: 17, y: 16, kind: 'ch3_district', label: '정정 보도 길',
      text: '남쪽 길바닥에 흩어진 종이들이 신문사 쪽으로 되감기듯 놓여 있다.\n정정 보도가 끝나면 이 길부터 조용해질 것 같다.' },
    { x: 27, y: 10, kind: 'ch3_district', label: '반짝 아케이드 문',
