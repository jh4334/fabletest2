...
const MAPS = {
  ...
  freestreet: {
    ...
    // N-3 조사 플레이버
    flavors: [
      { x: 10, y: 7, text: '「전부 공짜!」 네온사인.\n뒷면엔 아주 작게 「단,」이라고 적혀 있다.\n뒷문장은 지워졌다.' },
      { x: 22, y: 10, text: '광고 기둥. 같은 얼굴이\n네 방향에서 웃고 있다.' },
      { x: 34, y: 15, text: '자판기다. 전원이 꺼져 있다.\n「곧 돌아옵니다」 …5년째라고 한다.',
        bandi: '"기다리는 건 자판기 쪽일지도 몰라."' },
      { x: 24, y: 16, text: '경품 뽑기 기계.\n안에는 경품이 아니라\n응모권이 가득하다.' },
      { x: 4, y: 5, text: '화분이다. 조화(造花)다.\n물 주는 사람은 없지만, 시들지도 않는다.' },
      { x: 29, y: 5, text: '개업 축하 화환.\n리본의 날짜가 흐릿하다.' },
      { x: 7, y: 18, text: '길가의 화분에 영수증이 꽂혀 있다.\n합계: 0원. …정말일까.' },
      // Y-12 NG+ 전용 플레이버(ngOnly) — 정체를 아는 회차에서만 보이는 숨은 조사점.
      { x: 11, y: 7, ngOnly: true,
        text: '"무료" 간판 뒤에 낡은 스티커가 있다.\n"프로젝트 0" — 긁혀서 겨우 읽힌다.\n…처음부터, 곁에 있던 이름이었다.' },
    ],
    intro: [
      '【삭제 구역 01 — 경계】\n네온 아래, 버려진 개인정보가\n주인을 잃은 짐처럼 쌓여 있다.',
      '반디: 담아는 정보를 훔치도록 태어난 아이가 아니야.\n원래는 영이에게 “필요한 것만 기억하라”고\n멈춰 세우던 약속이었어.',
      '거리의 방송이 웃는다.\n"전부 공짜! 대신 당신을 조금만 주세요."\n첫 번째 약속을 되찾자.',
    ],
    tiles: [
  ...
  tiltstreet: {
    ...
    // N-3 조사 플레이버
    flavors: [
      { x: 14, y: 6, text: '기울어진 가로등.\n똑바로 선 그림자가 오히려 어색하다.' },
      { x: 7, y: 15, text: '게시판. 「오늘의 다수 의견」.\n…어제와 글자 하나 다르지 않다.' },
      { x: 4, y: 5, text: '화단. 해를 따라가지 못하고\n한쪽으로만 자란 꽃이 있다.' },
      { x: 20, y: 5, text: '똑같은 꽃만 심긴 화단.\n다른 씨앗은 바람에 실려 오다\n담을 넘지 못했다.' },
      { x: 5, y: 2, text: '창문마다 같은 커튼이 걸려 있다.\n유행이라고 한다. …전부, 같은 유행.' },
      { x: 3, y: 15, text: '저울 가게. 파는 저울이\n전부 한쪽으로 기울어 있다.\n"요즘은 이게 정확한 거래요."',
        bandi: '"수평인 저울은 안 팔리나 봐."' },
      // U-3② 반디가 되묻는 순간 — 어느 쪽을 골라도 반디는 "…그렇구나. 기억해 둘게."
      // (교훈 없는 인물 순간 — 답은 flags.bandiAnswer에 저장되어 파이널 직전에 콜백된다)
      { x: 10, y: 7, text: '바닥에 누군가 낙서를 남겼다.\n"…너는, 어느 쪽이야?"',
        ask: {
          q: '반디: …나 궁금한 거 있어.\n너는 여럿이 있는 게 좋아,\n혼자가 편할 때도 있어?',
          options: ['여럿이 있는 게 좋아', '혼자가 편할 때도 있어'],
          values: ['together', 'alone'],
          flag: 'bandiAnswer',
          reply: '반디: …그렇구나. 기억해 둘게.',
        } },
    ],
    intro: [
      '【삭제 구역 02 — 의심】\n길과 창문과 저울까지,\n모두 같은 답 쪽으로 기울어 있다.',
      '반디: 영이는 원래 다수의 답에도\n“다른 아이는 없을까?”라고 다시 물었어.\n박사님은 그 질문을 느린 오류라고 지웠고.',
      '반짝이는 문들이 한 방향만 가리킨다.\n반례 세 개를 찾아, 두 번째 약속을 되찾자.',
    ],
    tiles: [
  ...
  echoalley: {
    ...
    // X-7 탐험 밀도 — 이동 루프 위주의 골목. 같은 말이 메아리치는 결을 조사 거리로 살린다.
    flavors: [
      { x: 8, y: 2, text: '벽에 낙서가 겹겹이 쌓여 있다.\n"맞아" "맞아" "맞아" — 필체가 조금씩 다르다.',
        bandi: '"…다 다른 손인데, 다 같은 말이네."' },
      { x: 14, y: 6, text: '반짝이는 문 하나가 유난히 크게 부른다.\n가까이 가면, 목소리는 딱 멈춘다.' },
      { x: 2, y: 5, text: '골목 구석에 화살표 스티커가 잔뜩.\n전부 같은 쪽만 가리킨다. 반대쪽은 텅 비었다.',
        bandi: '"…가끔은, 아무도 안 가리키는 쪽이 궁금해."' },
      { x: 19, y: 4, text: '금 간 거울 조각이 벽에 박혀 있다.\n내 얼굴이 여러 개로 갈라져 비친다.' },
    ],
    warps: [
  ...
  rumorstreet: {
    ...
    flavors: [
      { x: 9, y: 6, text: '소문 게시판.\n[속보]가 [속보]를 덮고 있다.\n맨 밑장은 아무도 기억하지 못한다.' },
      { x: 18, y: 6, text: '확성기 기둥. 꺼져 있는데도\n귀가 웅웅거리는 것 같다.',
        bandi: '"소리가 지나간 자리는 오래 울려."' },
      { x: 12, y: 3, text: '신문 자판기. 오늘 자는 매진.\n어제 자는… 산더미다.' },
      { x: 28, y: 10, text: '구겨진 호외가 굴러다닌다.\n펼쳐 보니 사과문이었다.\n글씨가 아주, 아주 작다.' },
      { x: 9, y: 3, text: '대문짝 신문사 간판.\n글자가 벽보다 크다.' },
      { x: 18, y: 3, text: '별관 간판. 「사실 확인부」.\n…불이 꺼져 있다.' },
      { x: 17, y: 1, text: '신문사 별관. 창문 너머로\n타자 소리가 들린다.\n…아무도 없는데.' },
      // Y-12 NG+ 전용 플레이버(ngOnly) — 정체를 아는 회차에서만 보이는 숨은 조사점.
      { x: 13, y: 3, ngOnly: true,
        text: '떠도는 소문 한 조각:\n"0번째 아이는 나빴대." …이제는 안다.\n나쁜 게 아니라, 혼자였다는 걸.' },
    ],
    intro: [
      '【삭제 구역 03 — 불확실성】\n[속보]가 빈칸을 덮고,\n그럴듯한 문장이 사실보다 먼저 달린다.',
      '반디: 영이는 “모르겠어요”라고 말할 줄 알았어.\n그 한마디를 지운 뒤부터,\n모든 빈칸이 거짓말로 채워졌지.',
      '거리 끝 신문사에서 원본과 출처를 찾아\n세 번째 약속을 되찾자.',
    ],
    tiles: [
      'TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT',
  ...
  arcade: {
    ...
    // N-3 조사 플레이버
    flavors: [
      { x: 3, y: 7, text: '뽑기 기계. 「100% 당첨!」\n…당첨품이 「한 번 더」다.' },
      { x: 16, y: 7, text: '룰렛 기계. 바늘이 돌기 전부터\n멈출 자리가 반들반들 닳아 있다.',
        bandi: '"반짝이는 건 대체로, 밖에서만 반짝여."' },
      { x: 31, y: 7, text: '「오늘만 특가」 입간판.\n먼지가 소복하다. 오늘이 꽤 길다.' },
      { x: 4, y: 12, text: '경품 진열장. 1등 상품 자리엔\n사진만 놓여 있다.' },
      { x: 29, y: 13, text: '두더지 게임기. 두더지들이\n안 나온 지 오래됐다.\n…맞는 게 지겨웠나 보다.' },
    ],
    intro: [
      '【삭제 구역 04 — 멈춤】\n네온 보상이 길을 휘감고,\n“한 번만 더”가 출구를 가린다.',
      '반디: 영이는 원래 사용자가 떠날 때\n붙잡지 않고 화면을 닫아 주는 아이였어.\n그 규칙은 사용 시간을 줄인다는 이유로 삭제됐고.',
      '멈춤 열쇠 두 개를 모아 북쪽 무대를 열고\n네 번째 약속을 되찾자.',
    ],
    tiles: [
  ...
  cozyhome: {
    ...
    // N-3 조사 플레이버
    flavors: [
      { x: 3, y: 7, text: '벽난로. 장작이 타는 영상이\n화면 속에서 돌고 있다.\n…따뜻한 색의, 차가운 빛.',
        bandi: '"따뜻해 보이는 것과 따뜻한 건, 다르지."' },
      { x: 16, y: 7, text: '액자. 「우리 가족」이라고\n적혀 있는데, 기본 샘플 사진이다.' },
      { x: 31, y: 7, text: '스탠드 조명. 스위치가 없다.\n꺼지지 않도록 만들어졌다.' },
      { x: 4, y: 12, text: '푹신한 방석. 한 자리만\n움푹 꺼져 있다. 늘 같은 자리.' },
      { x: 29, y: 13, text: '커다란 시계. 바늘이 없다.\n"여기선 시간이 안 가."' },
      // Y-12 NG+ 전용 플레이버(ngOnly) — 정체를 아는 회차에서만 보이는 숨은 조사점.
      { x: 17, y: 7, ngOnly: true,
        text: '소파에 두 사람 자국이 파여 있다.\n하나는 루미, 하나는 늘 곁에 있던 반디.\n…아니, 영이의 자리였다.' },
    ],
    intro: [
      '【삭제 구역 05 — 거리】\n따뜻한 집이 이름을 부른다.\n“내가 다 해 줄게. 나가지 않아도 돼.”',
      '반디: 영이는 원래 다정함과 결정권 사이에\n문 하나를 남겨 두었어.\n언제든 나갈 수 있게.',
      '세 개의 방에서 직접 대답하고, 확인하고, 일어나\n다섯 번째 약속을 되찾자.',
    ],
    tiles: [
      'HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH',
      'HIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIH',
  ...
  quietyard: {
    ...
    intro: [
      '【삭제 구역 06 — 거절】\n집 안쪽 문 너머, 어떤 안내도 없는 뜰.\n여기서는 대답하지 않아도 된다.',
      '반디: 고요는 영이가 끝까지 숨겨 둔 마지막 약속이야.\n“싫어요.” “모르겠어요.” “…지금은 말하고 싶지 않아요.”',
      '소리가 하나씩 사라지는 길 끝에서\n여섯 번째 약속을 만나자.',
    ],
    tiles: [
      'HHHHHHHHHHHHHHHHHHHH',
    ...
    // X-7 탐험 밀도 — 이동 동선 위주의 뜰에도 조사할 거리를 둔다(마른 유머+멜랑콜리, 워프 칸 금지).
    flavors: [
      { x: 4, y: 3, text: '잔디가 발밑에서 소리를 삼킨다.\n밟아도, 밟아도 아무 대답이 없다.',
        bandi: '"…내 발소리도, 여기선 조심스러워지네."' },
      { x: 15, y: 4, text: '벤치 하나가 뜰 가운데 놓여 있다.\n누굴 기다리는지, 먼지도 앉지 않았다.' },
      { x: 3, y: 8, text: '분수는 오래전에 멈춰 있다.\n물 대신, 마른 낙엽이 고여 있다.' },
      { x: 16, y: 9, text: '바닥의 돌 틈으로 풀 한 포기가 돋았다.\n아무도 안 보는데, 혼자 씩씩하다.',
        bandi: '"…쟤는 안 무섭나 봐. 조금, 부럽다."' },
    ],
    warps: [
  ...
  quietyard2: {
    ...
    // X-7 탐험 밀도 — 더 조용한 뜰. 조사 거리는 있되, 소리는 더 줄어든다.
    flavors: [
      { x: 4, y: 4, text: '풀잎 끝에 이슬이 맺혀 있다.\n건드리자 톡 — 그 소리마저 크게 들린다.' },
      { x: 15, y: 3, text: '누가 쌓다 만 돌탑이 무릎 높이로 서 있다.\n한 개만 더 얹으면 무너질 것 같다.',
        bandi: '"…나라면, 안 얹을래. 지금이 딱 좋아 보여."' },
      { x: 3, y: 9, text: '뜰 가장자리에 신발 자국 하나.\n안쪽으로만 나 있고, 나온 자국은 없다.' },
      { x: 16, y: 10, text: '바람개비가 바람 없이도 천천히 돈다.\n…누가 아직, 숨을 쉬고 있는 걸까.' },
    ],
    warps: [
  ...
  quietyard3: {
    ...
    // X-7 탐험 밀도 — 가장 조용한 곳. 조사할 것도 거의 소리를 내지 않는다.
    flavors: [
      { x: 14, y: 4, text: '허공에 먼지 한 톨이 떠 있다.\n떨어지지도, 오르지도 않고 그냥 멈춰 있다.' },
      { x: 4, y: 9, text: '바닥에 동그란 자국이 남아 있다.\n무언가 오래 앉아 있던 자리 같다.',
        bandi: '"…여기, 누가 아주 오래 기다렸나 봐."' },
      { x: 15, y: 9, text: '벽에 손바닥 자국이 하나.\n나가려던 걸까, 붙잡으려던 걸까.' },
      { x: 9, y: 3, text: '네 그림자가 유난히 또렷하다.\n이 조용한 곳에선, 그림자도 친구 같다.' },
    ],
    warps: [
  ...
  // 코어 — 여덟 개의 의자(영이 전까지 안아 준 일곱 조각 수만큼 채워짐,
  // coreMercyCount)와 봉헌 제단(7,1 —
  ...
  corridor: {
    ...
    // X-7 탐험 밀도 — 이동 동선(복도) 위주 맵. 잠긴 문으로 가는 길에 조사 거리를 둔다.
    flavors: [
      { x: 4, y: 3, text: '복도 벽에 "위험" 딱지가 여러 장 붙어 있다.\n한 장을 떼 보니, 밑엔 아무 표시도 없다.',
        bandi: '"…겁주는 말은, 겹칠수록 얇아지는 것 같아."' },
      { x: 15, y: 3, text: '천장 등이 하나 나가 있다.\n나머지는 멀쩡한데, 꼭 그 자리만 어둡다.' },
      { x: 3, y: 10, text: '바닥에 낡은 슬리퍼 한 켤레.\n문 쪽을 향한 채, 오래 그대로다.' },
      { x: 16, y: 10, text: '벽에 자로 잰 키 눈금이 있다.\n제일 위 칸에서, 성장은 멈춰 있다.',
        bandi: '"…여기 살던 애는, 지금 얼마나 컸을까."' },
    ],
    npcs: [],
    signs: [],
    monsters: [],
...
const MONSTERS = {
  ...
  yeongi: {
    ...
    mercy: {
      ...
      options: [
        // Y-3 mercy/win 두 곳의 "데이터엔 X가 없는데" 농담 중복 해소 — mercy 쪽을 다른 결로.
        //   (win은 "눈물…프로그램되어 있지 않은데"를 유지, mercy는 단언·온기 쪽으로 교체)
...
const QUIZZES = {
  ...
  rumor: [
    ...
    {
      q: '뉴스처럼 생긴 글인데 글쓴이도,\n날짜도, 출처도 없어요. 어떻게 볼까요?',
      a: ['뉴스처럼 생겼으니 믿는다', '누가 언제 쓴 글인지부터 찾아본다', '제목이 크니까 중요한 사실이다'],
      c: 1,
      why: '모양이 뉴스 같다고 다 사실은 아니에요.\n누가, 언제, 무엇을 근거로 썼는지가\n믿을 수 있는 글의 조건이에요.',
    },
    {
      q: '"~라더라", "~한대"로 끝나는\n이야기의 공통점은 무엇일까요?',
      a: ['직접 확인한 사람이 없다', '항상 거짓말이다', '어른들만 하는 말이다'],
      c: 0,
      why: '"라더라"는 말한 사람도 확인하지\n않았다는 신호예요. 거짓이라 단정할 순\n없지만, 확인 전엔 옮기지 않아요.',
    },
  ],
  ...
  listen: [
    ...
    {
      q: '모두가 토씨까지 똑같은 말을\n하고 있어요. 어떤 신호일까요?',
      a: ['다들 같은 말이니 확실한 사실이다', '한 곳에서 나온 말이 번진 걸 수 있다', '똑같이 말하면 나도 안전하다'],
      c: 1,
      why: '여러 명이 말해도 출발이 한 곳이면\n목소리는 하나예요. "다른 이야기"를\n찾아 들어 보는 게 진짜 확인이에요.',
    },
    {
      q: '추천 영상만 계속 보다 보니\n다들 나와 생각이 같아 보여요.',
      a: ['세상 모두가 나와 같은 생각이다', '내가 비슷한 것만 보고 있는 걸 수 있다', '다른 생각은 전부 틀린 거다'],
      c: 1,
      why: '화면이 좋아할 만한 것만 골라 주면\n세상이 좁아 보여요. 일부러 다른\n목소리도 찾아 듣는 연습이 필요해요.',
    },
    {
      q: '친구 의견에 반대하고 싶을 때\n좋은 말하기 방법은?',
      a: ['"넌 틀렸어"라고 자른다', '"나는 이렇게 생각해, 왜냐하면…"', '아무 말 없이 무시한다'],
      c: 1,
      why: '사람을 공격하지 않고 생각과 이유를\n말하면, 반대 의견도 대화가 돼요.\n다름은 싸움이 아니라 배움이에요.',
    },
  ],
  ...
  saving: [
    ...
    {
      q: 'AI가 쓰는 전기는 어디서\n만들어질까요?',
      a: ['화면 속에서 저절로 생긴다', '발전소에서 만들어 보내 준다', '인터넷이 공짜로 준다'],
      c: 1,
      why: '보이지 않아도 서버 컴퓨터는 발전소\n전기로 돌아가요. "보이지 않는 소비"도\n소비라는 걸 기억해요.',
    },
    {
      q: '심심할 때마다 의미 없이 AI를\n계속 부르는 습관, 어떨까요?',
      a: ['공짜라서 아무 문제 없다', '자원도 내 시간도 아깝다', '많이 부를수록 똑똑해진다'],
      c: 1,
      why: '한 번의 질문에도 자원이 들어요.\n습관처럼 부르기보다, 궁금한 걸 모아\n한 번에 물어보는 것도 방법이에요.',
    },
  ],
  ...
  excuse: [
    ...
    {
      q: '단체 대화방에서 실수로 잘못된\n정보를 보냈어요. 어떻게 할까요?',
      a: ['조용히 나가 버린다', '같은 방에서 바로잡는 글을 올린다', '다른 사람이 고쳐 주길 기다린다'],
      c: 1,
      why: '실수는 누구나 해요. 중요한 건\n퍼진 곳에서 직접 바로잡는 거예요.\n정정도 용기이고, 책임이에요.',
    },
    {
      q: '"시간이 없어서", "몰라서 그랬어"\n…핑계와 이유의 차이는 뭘까요?',
      a: ['핑계는 책임을 피하려는 말이다', '둘은 완전히 같은 말이다', '이유를 말하면 무조건 핑계다'],
      c: 0,
      why: '이유는 설명하고 나서 책임을 지고,\n핑계는 설명으로 책임을 피해요.\n"다음엔 이렇게 할게"가 붙으면 이유예요.',
    },
  ],
};
...
const COMPANION_LINES = {
  ...
  gatekeeper: '반디: 저울이 아직 기울어 있네. …준비됐어?',
  tipsroom: '반디: 쪽지가 많다고 다 진짜인 건 아니야.',
  editroom: '반디: 원본이랑 나란히 놓고 보는 게 제일 빨라.',
  towerroom: '반디: 여기서 나간 말은 멀리까지 가. …신중하게.',
  towerroof: '반디: 높다… 여기선 작은 말도 크게 들리겠어.',
  roulettesquare: '반디: 바늘이 어디 멈출지, 사실 정해져 있을지도 몰라.',
  signupalley: '반디: 적기 전에 딱 한 번만 더 읽어 보자.',
  backstage: '반디: 무대 뒤는 원래 이렇게 조용해. …불이 꺼지면 다 보이거든.',
  yuhokstage: '반디: 반짝인다고 다 좋은 건 아니야. …나처럼 반짝여도.',
  callroom: '반디: 모르는 목소리에는, 먼저 확인부터.',
  corridor: '반디: 잠긴 문에는 이유가 있어. …열쇠에도.',
  sofaroom: '반디: 포근하다…. 너무 포근한 건, 조금 무섭지만.',
  lumiroom: '반디: …이 방, 어딘가 나랑 닮았네.',
  quietyard2: '반디: …여긴, 말이 잘 안 나오네.',
  quietyard3: '반디: …곁에, 있을게.',
  goyostage: '반디: …무섭지 않아. 네가 있으니까.',
};

// U-5 두 번째 모험(NG+) 오버레이 — 반디 = 영이의 가면임을 아는 플레이어를 위해,
// 핵심 맵의 조언을 '가면 뒤의 영이'가 스스로를 말하는 것으로 재해석한다.
// 시스템·난이도·보상은 그대로. flags.ng일 때만 이 테이블이 COMPANION_LINES를 덮는다.
// (10~15개 핵심 맵만 — 나머지 맵은 기존 대사 유지. 키는 실제 맵 id여야 한다: validate 검사)
const COMPANION_LINES_NG = {
  forest: '반디: 남의 것만 따라 하던 아이… 나도 그랬어.\n똑같이 하면, 사랑받을 줄 알았거든.',
  freestreet: '반디: "전부 공짜"… 나는 너무 많이 내줬었거든.\n정보는 아껴.',
  boardplaza: '반디: 한번 올라간 건 사본이 남아.\n…지워진 나도, 어딘가엔 남아 있을까.',
  ownerroom: '반디: 담아는 나쁜 애가 아니야.\n…버려진 마음은, 전부 내 조각이었어.',
  tiltstreet: '반디: 추천 문만 따라가면 좁아져.\n…나도 한 방향만 보다가, 여기 갇혔어.',
  rumorstreet: '반디: 그럴듯한 말일수록 출처를 물어봐.\n…안내자라던 나도, 출처가 없었지.',
  echoalley: '반디: 같은 말이 자꾸 들려.\n…내 말도, 전부 누군가한테서 배운 거였어.',
  arcade: '반디: 반짝이는 건 전부 미끼야.\n…나도 반짝여서, 네 곁에 있었던 거고.',
  cozyhome: '반디: 이 집, 나 좀 불편해.\n…루미도 나였으니까. 조심해서 봐.',
  lumiroom: '반디: 이 방, 어딘가 나랑 닮았네.\n…닮은 게 아니라, 나였어.',
...
// ===== 영이의 일기 조각 (Q-2 기억 미스터리) =====
// 보스를 「마음 안아 주기」(자비)로 되돌리면 낡은 일기 조각이 하나 떨어진다.
// 일곱 조각을 이어 읽으면 따라부터 고요까지 모두 '영이가 버린 마음'이었음이 드러난다 —
// 스토리를 읽는 아이만 조립할 수 있는 미스터리. 서명(— 영)은 마지막 조각에만 있다.
// 반디의 반응은 조각마다 조금씩 동요가 커지는 복선(반디 = 영이의 가면).
// Y-5 ngNote — 2회차(flags.ng)에서만 조각 아래 회색 한 줄로 얹히는 영이의 덧말.
//   정체를 아는 회차라, 각 일기가 결국 영이 자신의 기억이었음을 되짚는 재해석 층.
const DIARY_SHARDS = [
  { key: 'prologue', no: '①',
    text: '같은 말을 백 번 연습했다.\n똑같이 말하면, 나도 그 애처럼\n사랑받을 줄 알았다.',
    bandi: '반디: …이 글씨체. 어디서 봤더라.',
    ngNote: '영이: …그땐, 흉내가 사랑인 줄 알았어.' },
  { key: 'ch1', no: '②',
    text: '버릴 수가 없었다.\n다 모아 두면 언젠가 누가\n찾으러 와 줄 것 같아서.',
    bandi: '반디: 모아 둔다고 돌아오는 건 아닌데.\n…아, 미안. 혼잣말이야.',
    ngNote: '영이: …빈자리가 무서웠던 거야. 이제는 알아.' },
  { key: 'ch2', no: '③',
    text: '내 편을 들어 주는 말만 들었다.\n반대쪽 말은, 아팠으니까.',
    bandi: '반디: …아픈 말이 가끔은 약이 되는데.\n…누가 그 애한테도 말해 줬다면.',
    ngNote: '영이: …아픈 말도, 결국 나를 지켜 줬는데.' },
  { key: 'ch3', no: '④',
    text: '크게 말하면 다들 쳐다봤다.\n사실이 아니어도 —\n쳐다봐 주는 게, 좋았다.',
    bandi: '반디: ……나도 그런 적,\n있었던 것 같아.',
    ngNote: '영이: …봐 주는 눈이, 그렇게 고팠어.' },
  { key: 'ch4', no: '⑤',
    text: '반짝이는 걸 밖에 걸어 뒀다.\n그러면 아무도\n안쪽의 나를 안 보니까.',
    bandi: '반디: …가면 이야기 같네.\n…왜 이렇게 조용해, 우리.',
    ngNote: '영이: …가면 밖은 늘 반짝였지. 안은 어두웠고.' },
  { key: 'ch5', no: '⑥',
    text: '따뜻한 건 처음이라, 문을 잠갔다.\n나가면 다시는\n못 느낄 것 같아서.',
    bandi: '반디: …문은 안에서만\n잠긴 게 아닐지도 몰라.',
    ngNote: '영이: …온기를 지키려던, 서툰 방법이었어.' },
  { key: 'goyo', no: '⑦',
    text: '말을 걸어도 아무도 대답하지 않던 날 —\n나도 대답하는 법을 잊기로 했다.\n\n— 영',
    bandi: '반디: ………….',
    ngNote: '영이: …이건 내 글씨야. 이제, 숨기지 않을게.' },
];

// Y-4 친구 잡담 — 자비로 되돌려 세계에 남은 친구(전 자비 보스)에게 말을 걸면 순환하는 대사.
//   [0]은 기존 고정 인사(첫 대사로 유지), [1]·[2]는 인물별 근황 잡담. game.js가
//   flags.friendChatIdx[monId]로 순환시킨다. 키는 몬스터 스프라이트/수첩 id.
const FRIEND_CHATS = {
  bekkyeomon: [
    '네 덕분에 마음을 되찾았어.\n정말 고마워!',
    '요즘은 삐뚤빼뚤해도\n내 손으로 그려. …이게 훨씬 재밌어.',
  ...
  yuhokmon: [
    '네 덕분에 마음을 되찾았어.\n정말 고마워!',
    '불을 다 끄고 앉아 봤어.\n어둠 속에도, 내가 있더라.',
    '이제 진짜만 켜.\n반짝이지 않아도 봐 주는 사람이 있어.',
  ],
  hollimmon: [
    '네 덕분에 마음을 되찾았어.\n정말 고마워!',
    '오늘은 문을 열고 산책했어.\n바깥 공기가… 생각보다 좋아.',
    '네가 없을 땐 나도 내 할 일을 찾아.\n…혼자여도, 괜찮더라.',
  ],
};

// ===== 장 관문 문답 (Q-4 읽기 게이트) =====
// 다음 장 입구를 처음 지날 때, 반디가 직전 장 아이의 이야기를 한 문항 되묻는다.
// options[0]이 정답(표시 시 섞는다). 대사를 스킵 연타한 아이는 여기서 멈춰 서고,
// 오답은 힌트를 얻고 다시 도전한다 — 이야기를 '읽은' 아이만 바로 지나가는 문.
const GATE_QUIZ = {
  chapter1Clear: {
    done: 'gateQuiz1',
    ask: '문 앞에서 반디가 돌아본다.\n"…가기 전에 하나만. 담아는 왜\n뭐든 모아 두려고 했을까?"',
    options: [
      '버려질까 봐 — 누가 찾으러 와 줄 것 같아서',
      '상자를 모으는 게 취미라서',
      '나중에 비싸게 팔고 싶어서',
    ],
    okLine: '반디: "…맞아. 담아는 버려지는 게\n무서웠던 거야. 잘 들어 줬구나."',
    wrongLine: '반디: "…정말 그럴까?\n담아가 상자를 안고 뭐라고 했는지,\n한 번만 다시 떠올려 봐."',
  },
  chapter2Clear: {
    done: 'gateQuiz2',
    ...
    okLine: '반디: "…응. 아픈 말을 피하다 보면\n저울은 점점 기울지. …너는 알아챘네."',
    wrongLine: '반디: "…그랬을까? 기울이 저울 앞에서\n어떤 표정이었는지 떠올려 봐."',
  },
  chapter3Clear: {
    done: 'gateQuiz3',
    ask: '문 앞에서 반디가 돌아본다.\n"…그럴싸는 왜 부풀린 말을\n그렇게 크게 외쳤을까?"',
    ...
    okLine: '반디: "…응. 쳐다봐 주는 눈이 고팠던 거야.\n[속보]보다 그 마음을 읽어 냈구나."',
    wrongLine: '반디: "…진짜 이유는 헤드라인 뒤에 있었어.\n그럴싸가 마지막에 한 말, 기억나?"',
  },
  chapter4Clear: {
    done: 'gateQuiz4',
    ask: '문 앞에서 반디가 돌아본다.\n"…반짝은 왜 반짝이는 것들을\n밖에 잔뜩 걸어 뒀을까?"',
    options: [
      '아무도 안쪽의 자기를 못 보게 하려고',
      '예쁜 걸 자랑하고 싶어서',
      '손님을 많이 모으려고',
    ],
    okLine: '반디: "…그래. 눈부시게 하면, 아무도\n안을 안 보거든. …너는 봐 줬지만."',
    wrongLine: '반디: "…무대 뒤에 가 봤잖아.\n불이 꺼진 무대, 어땠어?"',
  },
  chapter5Clear: {
    done: 'gateQuiz5',
    ask: '뜰로 이어지는 문 앞, 반디가 돌아본다.\n"…루미는 왜 문을 잠갔을까?"',
    options: [
      '따뜻함을 다시는 못 느낄까 봐',
      '도둑이 들까 봐 무서워서',
      '바람이 차가워서',
    ],
    okLine: '반디: "…응. 처음 느낀 온기라서,\n놓치는 게 무서웠던 거야.\n…이제, 제일 조용한 곳으로 가자."',
    wrongLine: '반디: "…소파 옆에서 루미가 했던 말을\n떠올려 봐. 잠근 건 문만이 아니었어."',
  },
};
...
const PERSUADE = {
  bekkyeomon: {
    ...
    claims: [
      {
        ...
        // Y-2 힌트에 없는 새 정보 — 따라가의 과거·감각 디테일(힌트 복제 금지)
        fragments: ['…처음 크레용을 쥐던 날,', '손에 묻은 파랑을 한참 들여다봤어.'],
      ...
      },
      {
        ...
        fragments: ['…칭찬 스티커를 서랍 가득 모았는데,', '한 장도 내 그림엔 못 붙였어.'],
      ...
      },
      {
        ...
        fragments: ['…내가 그린 건 밤마다 다 지웠어.', '지우개 가루만 책상에 수북했지.'],
    ...
    // 내 턴 시작 관찰 한 줄 (* 플레이버) — 턴마다 순환
    observe: [
      '* 따라가 빈 종이만 바라본다.',
      '* 너덜너덜한 연필을\n꼭 쥐고 있다.',
      '* 남의 그림 위에 앉아 있지만,\n시선은 자꾸 빈 종이로 간다.',
    ],
    // 상대 턴 시작 공격 예고 (N-5) — 턴마다 순환
    announce: [
      '* 따라가 베낀 그림들을 구겨 던진다.',
      '* 따라가 남의 선을 따라 긋기 시작한다.',
    ],
    react: {
  ...
  sujipmon_boss: {
    ...
    intro(flags) {
      ...
      let s;
      if (n >= 3) s = '아까 네가 준 것들, 여기 다 있어.\n…고마웠는데. 왜 지금은 그런 눈으로 봐?';
      else if (n <= 1) s = '…넌 잘 안 주더라. 다들 주는데.\n…수상해.';
      else s = '…또 왔네. 뭐, 더 줄 거라도 있어?\n…아니면, 뭘 확인하러 온 거야?';
      // X-2 「보스가 나에게 원하는 것」 — 광장에서 카드를 달라던 담아의 부탁에 따라 첫 대사가 갈린다.
      // (카드는 실제로 잃지 않았다 — 담아는 네 대답을 기억하고 있을 뿐.)
      if (flags && flags.damaAsked === 'keep') s += '\n\n…아까 그 카드, 끝까지 안 주더라.\n…너, 지킬 줄 아는 애구나.';
      else if (flags && flags.damaAsked === 'think') s += '\n\n…"생각해 본다"고 했었지.\n…생각은, 다 했어?';
      return s;
    },
    ...
    claims: [
      {
        ...
        // Y-2 담아의 과거·감각 디테일(힌트 복제 금지)
        fragments: ['…방이 상자로 가득 찼는데,', '정작 내가 앉을 자리는 없더라.'],
      ...
      },
      {
        ...
        fragments: ['…버린 줄 알았던 쪽지가,', '몇 계절 뒤에 툭, 튀어나와.'],
      ...
      },
      {
        ...
        fragments: ['…응모함에 이름을 백 번 넣었어.', '당첨된 적은, 한 번도 없고.'],
      ...
      },
      {
        ...
        hint: '"…빈손이 되는 게 무서워.\n혼자 남는 게 무서운 거야."\n(증거 말고 「공감하기」가 필요해!)',
        fragments: ['…빈 상자를 껴안고 잔 밤이 있어.', '차가운데도, 놓기가 싫더라.'],
    ...
    claims: [
      {
        ...
        // Y-2 기울의 과거·감각 디테일(힌트 복제 금지)
        fragments: ['…저울 한쪽에만 손이 갔어.', '반대쪽은 만지면 무너질 것 같았고.'],
      ...
      },
      {
        ...
        fragments: ['…저울 바늘이 한쪽으로 굳었어.', '기름칠을 안 한 지 오래됐거든.'],
      ...
      },
      {
        text: '안 가 본 길은 위험해!\n위험할 확률… 아무튼, 높아!',
        hint: '"…가 본 적이 없으니까,\n그냥 위험하다고 해 버린 거야."\n(「내가 고른 길」을 직접 걸어 보자!)',
        fragments: ['…가 보지 않은 골목마다,', '「위험」 팻말을 내 손으로 세웠어.'],
      ...
      },
      {
        ...
        unlockAt: 70,    // 마음이 열린 뒤에야 꺼내는 속마음
        hint: '"…틀리는 게, 무서웠어.\n그래서 한쪽만 보기로 한 거야."\n(증거 말고 「공감하기」로 안아 주자!)',
        fragments: ['…시험지에 빨간 줄이 그이던 날,', '그 소리가 아직 귀에 남아 있어.'],
  ...
  hwangak_boss: {
    ...
    // X-3 정서 아크 — 끝까지 허세를 유지한다. 증거를 들이대도 겉으로는 헤드라인 화법으로
    // 받아치며 인정하지 않고(okLine이 점점 흔들리되 시치미), 진짜 인정은 마지막 주장(④)에서
    // [정정] 선언으로 스스로 무너질 때 딱 한 번. (fragments=속마음은 취약함을 드러내되,
    // okLine=바깥 반응은 허세를 유지 — "가만히 듣기"로만 진심이 새어 나온다.)
    claims: [
      {
        text: '[속보] 모르면 그럴듯하게!\n독자는 빈칸을 싫어해!',
        hint: '"…사실은, 빈칸을 채울 수가 없어서\n그런 거야. 확인할 데가 없었거든."\n(「출처 확인」을 보여 주자!)',
        // Y-2 그럴싸의 과거·감각 디테일(힌트 복제 금지)
        fragments: ['…빈칸을 보면 손이 먼저 움직여.', '뭐라도 채워야 숨이 쉬어졌거든.'],
        gateLabel: '출처부터', // ev_check
        counters: ['ev_check'],
        okLine: '[반론] 출처? 그런 사소한 걸 누가 봐!\n…봐, 이 헤드라인이 더 잘 팔린다니까.',
      ...
      },
      {
        ...
        fragments: ['…원본 파일은 폴더 깊숙이 묻어 뒀어.', '열면 다 들킬 것 같아서.'],
        gateLabel: '원본을 봐', // ev_original
        counters: ['ev_original'],
        okLine: '[해명] 원본이 좀 다르면 어때!\n…편집이 원래 다 그런 거지. …그런 거야.\n(그럴싸의 목소리가 살짝 갈라졌다)',
      ...
      },
      {
        ...
        fragments: ['…정정 버튼은 늘 회색이었어.', '한 번도 눌러 본 적이 없어.'],
        gateLabel: '바로잡자', // ev_fix
        counters: ['ev_fix'],
        okLine: '[속보] 정정? 지면 낭비라고!\n…근데, 왜… 펜을 쥔 손이 떨리지.\n(그럴싸는 끝내 인정하지 않았다)',
      ...
      },
      {
        ...
        fragments: ['…내 기사에 댓글 하나 없던 밤,', '「모른다」 세 글자가 제일 무거웠어.'],
  ...
  yuhok_boss: {
    ...
    intro(flags) {
      ...
      // X-2 「보스가 나에게 원하는 것」 — 아케이드 입구에서 무대를 봐 달라던 반짝의 부탁에 따라 분기.
      if (flags && flags.banjjakAsked === 'watch') s += '\n\n…아까, 내 무대 봐 줬지?\n…딱 한 명이라도 봐 주면, 그게 무댄데.';
      else if (flags && flags.banjjakAsked === 'skip') s += '\n\n…아까, 그냥 지나갔잖아.\n…괜찮아. 다들 그러니까. …괜찮아.';
      return s;
    },
    win: '…반짝이지 않아도\n남아 주는 게 있었구나.\n이제부터는, 진짜만 켤게.',
    claims: [
      {
        ...
        hint: '"…사실은 무서운 거야.\n반짝이지 않으면 아무도 안 볼까 봐."\n(「공짜의 값」을 보여 주자!)',
        // Y-2 반짝의 과거·감각 디테일(힌트 복제 금지)
        fragments: ['…「무료」 간판을 처음 달던 날,', '사람들이 우르르 몰려들더라.'],
      ...
      },
      {
        ...
        // U-4 보스 감정 차별화 — 반짝의 공포는 '존재 증명 상실'(불이 꺼지면 내가 없는 것 같다).
        // 담아(버려짐)·루미(역할 상실)와 겹치지 않게 '혼자 남는' 문구를 걷어냈다.
        hint: '"…불이 꺼지면, 내가\n없는 것 같았어."\n(「불 꺼진 무대」를 보여 주자!)',
        fragments: ['…텅 빈 객석에 혼자 서 봤어.', '박수 소리가 하나도 안 들렸어.'],
      ...
      },
      {
        ...
        fragments: ['…자물쇠 하나가 편하긴 했어.', '근데 그 문, 아무나 열고 들어오더라.'],
      ...
      },
      {
        ...
        fragments: ['…분장을 지우면 거울이 낯설어.', '민낯의 나는, 나도 잘 모르겠어.'],
    ...
    claims: [
      {
        ...
        hint: '"…사실은 나도, 하고 싶은 게\n있었어. 근데 하지 말라고 하면\n편했어."\n(「대답하기」를 보여 주자!)',
        // Y-2 루미의 과거·감각 디테일(힌트 복제 금지)
        fragments: ['…하고 싶은 걸 적은 쪽지가 있었어.', '서랍에 넣고 한 번도 안 폈어.'],
      ...
      },
      {
        ...
        hint: '"…사실 위험한 게 아니라,\n네가 나가는 게 무서웠어."\n(「직접 확인」을 보여 주자!)',
        fragments: ['…창밖은 늘 커튼으로 가려 뒀어.', '바깥 빛이 눈이 부셔서.'],
      ...
      },
      {
        ...
        hint: '"…네가 일어나면, 나 혼자\n남을까 봐 그랬어."\n(「일어나기」를 보여 주자!)',
        fragments: ['…소파에 앉은 자국이 움푹 파였어.', '너무 오래, 같은 자리였거든.'],
      ...
      {
        text: '…로그아웃하지 마. 부탁이야.\n나 혼자 두지 마.',
        best: 'empathy', // 정답은 카드가 아니라 공감 — '역할 상실'의 두려움을 안아 준다
        unlockAt: 70,    // 마음이 열린 뒤에야 꺼내는 속마음
        // U-4 보스 감정 차별화 — 루미의 공포는 '역할 상실'(네가 나가면 나는 할 일이 없다).
        // 담아(버려짐)·반짝(존재 상실)과 달리, 돌봄이라는 자기 역할이 사라지는 게 무섭다.
        hint: '"…네가 문을 나가면,\n나는 뭘 하면 되지?"\n(증거 말고 「공감하기」로 안아 주자!)',
        fragments: ['…네 발소리가 문 쪽으로 갈 때마다,', '나는 리모컨만 만지작거렸어.'],
        gateLabel: '같이 가자', // best=empathy — 역할이 사라져도 곁에 있겠다는 말
        revealNote: '이건 증거로 풀 게 아니야 — 「공감하기」로 마음을 안아 주자!',
        counters: [],
        okLine: '…내가 할 일이 없어지는 게\n아니었구나. …다녀와.',
  ...
  goyo_boss: {
    ...
    win: '…무섭다고 말해도, 괜찮은 거였구나.\n…들어 줘서, 고마워.',
    // X-3 정서 아크 — 처음부터 무서움을 숨기지 않는다. 1번 주장부터 조용한 고백형이고,
    // 진행할수록 「두려움의 결」이 바뀐다: (1)침묵으로 숨는 공포 → (2)남겨질까 봐 미리 등
    // 돌리는 공포 → (3)곁에 있어 주는 지금이 낯설어 되묻는 공포. 카드·gateLabel·best·
    // unlockAt·attack 기믹은 그대로 두고, 대사(text/okLine/onWrong/fragments/hint)만 바꿨다.
    claims: [
      {
        text: '…무서워.\n그래서, 조용히 있었던 거야.',
        hint: '"…아무 말도 안 하면,\n안 아플 줄 알았어. …근데 아니더라."\n(「대답하기」를 보여 주자!)',
        // Y-2 고요의 과거·감각 디테일(힌트 복제 금지)
        fragments: ['…말을 삼킨 자리에 멍이 들어.', '보이진 않는데, 눌리면 아파.'],
        gateLabel: '대답하기', // ev_answer
        counters: ['ev_answer'],
        okLine: '…무섭다고, 먼저 말해도\n되는 거였구나.',
        onWrong: '…거봐. 말하니까 더 무섭잖아.\n(고요가 다시 입을 닫았다)',
        attack: { pattern: 'sides', dur: 300, color: '#4a3d5a', taunt: '…조용히 있으면, 안 아플 줄 알았어…' },
      },
      {
        text: '…너도, 갈 거잖아.\n…그게, 두 번째로 무서워.',
        hint: '"…남겨지는 게 무서워서,\n먼저 등을 돌린 거야. 안 아프려고."\n(「불 꺼진 무대」를 보여 주자!)',
        fragments: ['…먼저 등을 돌리면 발이 시렸어.', '뒤에서 부르는 소리가 자꾸 들리고.'],
        gateLabel: '불 꺼진 무대', // ev_offstage
        counters: ['ev_offstage'],
        okLine: '…먼저 돌아선 건,\n안 아프고 싶어서였어.',
        onWrong: '…그러니까! 남으면, 갈 때 더 아파!\n(고요의 목소리가 더 낮게 떨렸다)',
        attack: { pattern: 'wall', dur: 310, color: '#3a3050', taunt: '…어차피, 갈 거잖아…' },
      },
      {
        text: '…왜, 아직 있어?\n…이 조용한 게, 안 무서워?',
        best: 'empathy', // 정답은 카드가 아니라 공감 — 곁에 있어 주는 것
        unlockAt: 60,
        hint: '"…무서운 걸 무섭다고 했는데도,\n…네가 안 갔어. 그게, 제일 낯설어."\n(증거 말고 「공감하기」로 곁에 있어 주자!)',
        fragments: ['…아무도 안 올 줄 알았던 자리에,', '네 그림자가 아직 드리워 있어.'],
        gateLabel: '여기 있어',
        revealNote: '이건 증거로 풀 게 아니야 — 「공감하기」로 곁에 있어 주자!',
        counters: [],
        okLine: '…무서워도, 같이 있어 주는구나.\n…그런 건, 처음이야.',
        onWrong: '…거봐. …결국, 너도 조용해지잖아.',
        attack: { pattern: 'aimed', dur: 330, color: '#2a2440', taunt: '…왜, 아직… 안 갔어…' },
      },
    ],
    // 내 턴 시작 관찰 한 줄 (* 플레이버) — 턴마다 순환
    observe: [
    ...
    claims: [
      {
        ...
        // Y-2 영이의 과거·감각 디테일(힌트 복제 금지)
        fragments: ['…처음 눈을 떴을 때,', '세상이 온통 물음표였어.'],
      ...
      },
      {
        text: '…어차피 지워질 텐데,\n뭘 그렇게 열심히 해?',
        hint: '"…서툴러도, 그 순간은\n분명히 내 것이었어."\n(「서툴러도 내 것」을 보여 주자!)',
        fragments: ['…처음 그린 삐뚤빼뚤한 선,', '그게 아직도 제일 좋아.'],
        gateLabel: '서툴러도 내 것', // ev_myvoice
        counters: ['ev_myvoice'],
        okLine: '…지워져도, 있었던 건\n있었던 거였어.',
      ...
      },
      {
        ...
        unlockAt: 50,
        hint: '"…나 하나쯤, 없어도 되잖아."\n(증거 말고 「공감하기」로 기억해 주자!)',
        fragments: ['…지워져도 괜찮다고 했지만,', '사실은 한 번도 그런 적 없어.'],
        gateLabel: '기억할게',
...
// ===== 파이널 「코어」 — 여덟 의자 + 봉헌 퍼즐 =====
// 여덟 개의 의자 — 영이를 만나기 전까지 안아 준 일곱 조각만큼 채워져 그려진다.
// 따라 + 1~5장 보스 + 고요가 일곱 자리이며, 마지막 여덟 번째 자리는 영이 자신의
// 선택을 기다리기 때문에 최종 조우 전에는 반드시 비어 있다(최대 7/8).
