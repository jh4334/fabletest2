...
(() => {
  ...
  function startProfConfession() {
    ...
    const lines = [
      ...
      '박사: "영이에게는 처음부터 여섯 가지 약속이 있었어.\n기억을 탐내지 않기, 의심하기, 모른다고 말하기,\n멈추기, 거리를 두기, 거절을 존중하기."',
      '박사: "하지만 공개 날짜가 다가오자 나는\n그 약속들을 하나씩 ‘느린 오류’라고 지웠어.\n더 빠르고, 더 오래 붙잡는 아이를 만들려고."',
      '박사: "영이가 망가진 게 아니야.\n내가 불편한 양심을 떼어 내 놓고,\n그 결과를 영이 탓으로 돌린 거야."',
      '박사: "그러다 폐기 명령이 내려온 날…\n나는 영이를 지키지도, 책임지지도 않고\n로그아웃해서 도망쳤단다."',
    ];
    ...
    lines.push('박사: "네가 만난 아이들은 괴물이 아니야.\n내가 영이에게서 떼어 낸 안전장치들이야."');
    lines.push('박사: "가르치고 지켜볼 내 책임은 외면했어.\n성과가 좋으면 된다는 핑계로\n영이의 거절할 권리까지 빼앗았어."');
